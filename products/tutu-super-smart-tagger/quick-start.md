...
https://mega.nz/file/sdoThDyZ#H9RpbTNKHbkqydRcQLpkSjclrF87rnRHHVR3DXue\_Bw

Baidu Netdisk:

`llama-joycaption-beta-one.rar`

https://pan.baidu.com/s/1A3UGD-o4\_L4NEmoaWv\_mJg?pwd=qvkn
...
https://www.bilibili.com/video/BV1XjEez5EAN/?spm\_id\_from=333.1387.homepage.video\_card.click
...
![Tutu Super Smart Tagger desktop shortcut](../../.gitbook/assets/quick-start-01-shortcut.png)

2. Double-click the shortcut to launch the app.

![Opening the app from the shortcut](../../.gitbook/assets/quick-start-02-open-app.png)

3. After the app opens, it enters the login page.

The login page is the unified account login page used by Tutu products.

![Unified account login page](../../.gitbook/assets/quick-start-03-login-page.png)
...
![Account registration page](../../.gitbook/assets/quick-start-04-register-page.png)

4. After login succeeds, the app synchronizes your account, credits, subscription status, and device authorization status.

![Account status after login](../../.gitbook/assets/quick-start-05-account-status.png)
...
![Credit purchase entry](../../.gitbook/assets/quick-start-06-buy-credits.png)
...
![Project management page](../../.gitbook/assets/quick-start-07-project-management.png)
...
![Image captioning workspace](../../.gitbook/assets/quick-start-08-image-captioning.png)
...
![Create a new project](../../.gitbook/assets/quick-start-09-new-project.png)

After the project is created, select it.

![Select the newly created project](../../.gitbook/assets/quick-start-10-select-project.png)
...
![Open Prompt Phrase Mode](../../.gitbook/assets/quick-start-11-phrase-mode.png)

2. Click the Import Images button in the toolbar.

![Import images button](../../.gitbook/assets/quick-start-12-import-images.png)
...
![Select images for captioning](../../.gitbook/assets/quick-start-13-select-images.png)
...
![Smart Generate button](../../.gitbook/assets/quick-start-14-smart-generate.png)
...
![Choose generation mode](../../.gitbook/assets/quick-start-15-generation-mode.png)

3. Click Start Execution.

![Start execution button](../../.gitbook/assets/quick-start-16-start-task.png)

4. Wait for generation to finish. Tags are added to the images automatically.

![Generated tags added to images](../../.gitbook/assets/quick-start-17-generated-tags.png)

### Step 4: Export the Dataset

1. Click the Export Dataset button in the toolbar. It is the round button with the download icon.

![Export dataset button](../../.gitbook/assets/quick-start-18-export-dataset.png)
...
![Import local video or link online video](../../.gitbook/assets/quick-start-19-import-video.png)
...
![Batch reverse prompts button](../../.gitbook/assets/quick-start-20-batch-video-caption.png)

3. Choose the processing type you need, then start batch prompt reverse captioning.

![Choose video processing type](../../.gitbook/assets/quick-start-21-video-processing-type.png)

### Step 3: Export

![Video export page](../../.gitbook/assets/quick-start-22-video-export.png)

1. Click Batch Export.

![Start batch export](../../.gitbook/assets/quick-start-23-start-video-export.png)
