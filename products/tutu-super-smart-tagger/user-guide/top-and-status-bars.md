...
![Top navigation bar](../../../assets/tutu-super-smart-tagger/user-guide/top-and-status-bars/top-and-status-bars-01.png)

Top bar update-check feedback. After clicking Check Updates, the app directly displays the current version state.

![Top bar update-check feedback](../../../assets/tutu-super-smart-tagger/user-guide/top-and-status-bars/top-and-status-bars-02.png)
...
![Account and Credits entry](../../../assets/tutu-super-smart-tagger/user-guide/top-and-status-bars/top-and-status-bars-03.png)
